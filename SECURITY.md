...
Currently, only the latest version of Pandora is actively supported with security updates.
...
When using Pandora in your projects:

- Keep dependencies up to date
- Review security advisories for dependencies
- Use the latest stable version of Pandora
